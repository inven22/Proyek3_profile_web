...
@section('content')
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">{{ __('Tambah Cv') }}
                        <center> <a href="add_cv" id="get-started-button">Mode biasa</a></center>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ URL::to('insert_cv') }}" enctype="multipart/form-data">
                            ...
                            <div class="slide" id="slide4" style="display: none;">
                                ...
                                <button type="submit" class="btn btn-primary" id="next4">Skip</button>
                            </div>
    ...
    <script src="{{ asset('js/tab_mode.js') }}"></script>
    <script>
